export default function VisionMission() {
    return (
        <div className="mx-auto max-w-5xl px-4 py:4 md:py-10">
            <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1 rounded-2xl p-8 bg-[#1B4C7E] text-white">
                    ...
                    <p className="text-base leading-relaxed text-white/90 max-md:text-justify">
                ...
                <div className="flex-1 rounded-2xl p-8 bg-white text-[#1B4C7E] border border-[#1B4C7E]/30">
                    ...
                    <p className="text-base leading-relaxed text-gray-600 max-md:text-justify">
