          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 text-[15px] leading-8 text-gray-600">
                ...
                project development, engineering, construction, real estate,
        ...
        <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 text-[15px] leading-8 text-gray-600">
                From wave power installations off the coast to pumping
                complexes inland, our engineering teams work at the scale
                national infrastructure demands.
              </p>

              <p className="mt-5 text-[15px] leading-8 text-gray-600">
                We bring international partners and a decade of hands-on
                delivery experience to every site.
              </p>
